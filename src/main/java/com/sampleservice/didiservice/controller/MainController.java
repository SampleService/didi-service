package com.sampleservice.didiservice.controller;

import com.sampleservice.didiservice.utils.MBaseUtils;
...
public class MainController extends MObject {
    ...
    public MResponse carFunction(@RequestBody MResponse requestData) {
        ...
        if (requestData.get("interval") != null) {
            MBaseUtils.generateStringInKBSize(50, result, (int) requestData.get("interval"));
        }
        return result;
    }
}
